...
#ifndef __shipboard_zonal_scud__HH__
#define __shipboard_zonal_scud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(shipboard_zonal_scud) {
    ...
    SC_CTOR(shipboard_zonal_scud):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
