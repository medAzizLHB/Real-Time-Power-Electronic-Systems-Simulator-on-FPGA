...
#ifndef __shipboard_zonal_sfYi__HH__
#define __shipboard_zonal_sfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(shipboard_zonal_sfYi) {
    ...
    SC_CTOR(shipboard_zonal_sfYi):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
